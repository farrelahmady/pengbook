...
**Status**: ✅ Tahap 0 (preview dummy) Selesai · ✅ Tahap 1 (backend read: GET /assets/summary + GET /assets/groups) Selesai · ✅ Tahap 2 (frontend wiring + hapus dummy) Selesai · ✅ A10 ikon Batal (dihapus total dari halaman Aset) · ✅ Tahap 3 (kualitas: error/search/aria/i18n + skeleton baris) Selesai · 📋 Tahap 4 (mutasi: create + adjust-balance) Belum dimulai
